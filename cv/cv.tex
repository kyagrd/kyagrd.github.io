...
\textbf{Research Fellow} ~ (current position)
...
\section{Reviewer (Referee)}
Typed Lambda Calculus and Applications 2015\vspace{1mm}

Trends in Functional Programming 2013\vspace{1mm}

Higher-Order and Symbolic Computation (special issue for PEPM 2012) \vspace{1mm}

NASA Formal Methods Symposium 2011
\vspace*{-2mm}
...
\vspace*{1mm} \\
$[\textrm{u2}]$ \label{u2}
An executable relational specification of extensible records using logic programming\\ \hspace*{3.8ex} 
Ki Yung Ahn and others. ~~
(\href{https://www.sharelatex.com/project/571c920b55374a8e523e2d87}{An early draft plan available online}) ~~
\vspace*{1mm} \\
$[\textrm{u3}]$ \label{u3}
A Logical Characterisation of Open Bisimulation using an Intuitionistic Modal Logic.\\ \hspace*{3.8ex}
Ki Yung Ahn, Ross Horne, and Alwan Tiu. ~~
(available on \href{https://arxiv.org/abs/1701.05324}{Arxiv})
